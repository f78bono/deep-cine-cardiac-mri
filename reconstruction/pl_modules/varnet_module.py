...
from reconstruction.models import VarNet, VarNet_RNN
from .mri_module import MriModule


class VarNetModule(MriModule):
    """
    Pytorch Lightning module for training VarNet. 
    
    The architecture variations for dynamic MRI reconstruction are
    inspired by the End-to-End Variational Network for static MRI
    reconstruction, introduced in the following paper:
